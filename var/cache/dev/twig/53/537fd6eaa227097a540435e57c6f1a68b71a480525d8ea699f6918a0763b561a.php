...
class __TwigTemplate_1fa5592b2f7923ee6593cf5fc9c6966a1fa78c2a0e7201badd5cdc8070ec24ff extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        // line 10
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 10, $this->source); })()), "email", [], "any", false, false, false, 10), 'row', ["label" => "Email", "attr" => ["placeholder" => "Email"]]);
        echo "
    ";
        // line 11
    ...
    ";
        // line 12
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 12, $this->source); })()), "confirm_password", [], "any", false, false, false, 12), 'row', ["label" => "Confirmez le mot de passe", "attr" => ["placeholder" => "Confirmez le mot de passe"]]);
        echo "
...
{% block body %}
    ...
    {{ form_row(form.confirm_password,{'label':'Confirmez le mot de passe','attr': {'placeholder':'Confirmez le mot de passe'}}) }}

    <button type=\"submit\" class=\"btn btn-success\"> S'inscrire</button>

    {{ form_end(form) }}

{% endblock %}", "security/registration.html.twig", "/home/anicetnougaret/Work/Courses/2020-2021/s3/PWEB/projet/templates/security/registration.html.twig");
    }
}
